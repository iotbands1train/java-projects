package cosc1436.crn13271.summer2022.mod05mod06;
...
public class Instructor_Smith_topicC_jp4 {
            ...
            switch (selectorMainMenu_s1) {
                case 1:
                    while (runSignUp) {
                        ...
                        System.out.println("1 - Add Patient : user inputs ");

                        selectorAddPatient = userInput.nextByte();
                        System.out.println("*User Entered(selectorAddPatient) =" + selectorAddPatient);

                        switch (selectorAddPatient){
                            case 1:
                                ...
                                for (int i = 0; i < maxNumberOfUsers; i++) {
                                    ...
                                    points = (byte) (patientPainLevel + patientPainLocation
                                            + patientPainType);
                                    ...
                                    total = (float) (((TAXES_FEES) * patientCost)
                            ...
                            case 2:
                                ...
                                if (selectorSignUp_s2 == 1) {
                                    ...
                                    do {
                                        ...
                                        int suff = (int) (Math.random() * (9999 - 1111) + 1111);
